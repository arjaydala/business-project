<template>
  <header class="relative overflow-hidden bg-gradient-to-r from-pink-100 to-purpple-100" id="home">
    <article
    ...
    >
      ...
      <section class="w-full lg:w-1/2 text-center lg:text-left">
        ...
        <!-- Stats Section -->
        <aside data-aos="fade-uo" data-aos-delay="800" class="py-4">
      ...
      >
        <div class="relative w-full max-w-xs sm:max-w-sm md:max-w-md">
          <span
            class="bg-pink-500 rounded-full w-64 h-64 sm:w-80 sm:h-80 absolute -top-10 -left-10 opacity-20"
            aira-hidden="true"
          ></span>
          <span
            class="bg-purple-400 rounded-full w-48 h-48 sm:w-64 sm:h-64 absolute -bottom-10 -right-10 opacity-20"
          ></span>
          <img
            src="@assets/hero.png"
            alt="Woman smiling after cosmetic treatment"
